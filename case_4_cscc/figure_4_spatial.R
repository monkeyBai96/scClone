...
for(i in 1:2){
  ...
  ggsave(paste0("ST_celltype_all.pdf"),p1, width = 6, height = 5)
  ggsave(paste0("ST_celltype_split.pdf"),p2, width = 6*length(celltype), height = 5)
  ...
  ggsave(paste0("ST_cluster_new_split.pdf"),p2, width = 6*length(celltype), height = 5)
}
